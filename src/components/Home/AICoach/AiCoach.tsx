...
export default function AICoach() {
  ...
  return (
    <div className="w-full min-h-screen bg-blue-800 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        <header className="text-white mb-6">
          <div className="text-sm mb-1">Live AI Coach</div>
          <h1 className="text-3xl md:text-4xl font-bold">Take a Suggestion Coaching</h1>
        </header>
          ...
          <Card className="lg:col-span-2 bg-white rounded-lg overflow-hidden">
            ...
            <CardContent className="p-0">
              <div className="flex flex-col h-full">
                {/* Chat Messages */}
                <div className="flex-1 p-4 min-h-[300px] md:min-h-[400px] overflow-y-auto">
                ...
                <div className="border-t p-3 flex items-center">
                  ...
                  />
                  <Button size="sm" className="bg-blue-800 hover:bg-blue-700 ml-2 flex items-center gap-1">
                    Send
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <Card className="bg-white rounded-lg">
              <CardHeader className="p-4">
                <CardTitle className="text-lg font-medium">Real-time Analysis</CardTitle>
              </CardHeader>
              <CardContent className="p-4 pt-0 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-600">93% improvement in objection handling</p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-4 pt-0">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <Button variant="outline" className="h-auto py-6 flex flex-col items-center justify-center gap-2">
                    ...
                    <span className="text-xs">Practice Pitch</span>
                  </Button>
                </div>
              </CardContent>
            </Card>
